...
import { type ViewsAnalyticsChartProps } from './ViewsAnalyticsChart.types'

const ViewsAnalyticsChart = ({ unique, repeated }: ViewsAnalyticsChartProps) => {
  const chartConfig = {
    visitors: {
    ...
    <Card className="flex flex-col">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none">
          Try to don&apos;t have the same passwords <TrendingUp className="h-4 w-4" />
        </div>
